...
public class ProductServiceController {
    ...
    @RequestMapping(value = "/productIds/{product_ids}", method = RequestMethod.GET)
    public List<Product> getProductsByIds(@PathVariable("product_ids") List<Long> productIds) {
